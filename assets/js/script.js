...
function wa(isi) 
{
	open("https://wa.me/6288214797710?text=Makasih ya udah inget hari ulang tahun aku, di hari spesial ini aku mau " + isi)
}
...
async function makeawish() 
{
	var {
		...
		imageUrl: 'assets/img/content/r4.jpg',
	...
	if (kado) {
		await swal.fire({
			imageUrl: 'assets/img/content/r1.jpg',
